...
<div id="add-item" class="content-section hidden">
    <h2 class="text-3xl text-center">افزودن محصول</h2>



    <form action="{{ url('dash/upload_item') }}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto justify-items-center">
        @csrf
        <div class="relative z-0 w-full mb-5 group">
            ...
            <label class="peer-focus:font-medium absolute text-xl text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">اسم محصول</label>
        </div>
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <select name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                ...
                <option value="دان قهوه">دان قهوه</option>
                <option value="پودر قهوه">پودر قهوه</option>
