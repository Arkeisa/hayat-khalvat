        ...
        <div class="w-full bg-white rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-center text-3xl font-bold leading-10 tracking-wider text-gray-900">
                   <span class="text-4xl">به کافه حیات خلوت</span> <br> خوش آومدی
                </h1>
...
@csrf
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="name@company.com" required="">
                        @error('email')
                    ...
                    <button type="submit" class="btn btn-outline btn-md text-3xl w-full text-gray-900   text-center">ورود</button>
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            <div class="ml-3 text-sm">
                              <a href="/register" class="text-gray-900 text-2xl">ثبت نام</a>
                            </div>
                        </div>
